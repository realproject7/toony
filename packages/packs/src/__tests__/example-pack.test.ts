...
// is discoverable and contributes all three kinds — if the format changes and
// the example is not updated with it, this fails.
...
test("the committed example pack loads and contributes all three kinds", async () => {
